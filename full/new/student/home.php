    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <table style="width:60%; margin:0 auto">
                        <tr><td><h3>USN:</h3></td>
                        <td> <h3><?php echo $res['usn'];?></h3></td></tr>
                        <tr><td><h3>Branch:</h3></td>
                        <td> <h3><?php echo $res['branch'];?></h3></td></tr>
                        <tr><td><h3>SEMESTER:</h3></td>
                        <td> <h3><?php echo $res['sem'];?></h3></td></tr>
                        ...
                        <td> <h3><?php echo $res['address'];?></h3></td></tr> 
                    </table>
                </div>
            </fieldset>
                <!-- /.row -->
            <fieldset>
                ...
                <div class="row">
                    <table style="width:60%; margin:0 auto">
                   <tr><td><h3>Father's Name:</h3></td>
                        <td> <h3><?php echo $res['fathersname'];?></h3></td></tr> 
                        <tr><td><h3>Father's Email-ID :</h3></td>
                        <td> <h3><?php echo $res['fathersemail'];?></h3></td></tr> 
                    </table>
                </div>
            </fieldset>
                <!-- /.row -->

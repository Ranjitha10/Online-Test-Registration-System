...
$sched="SELECT * FROM schedule WHERE sem='$semester' AND internal=1 ";
$schedres= mysql_query($sched);
$schedcount=mysql_num_rows($schedres);
$sub1=$res2['subject1'];
$sched1="SELECT * FROM schedule WHERE sem='$semester' AND internal=1 AND subject='$sub1' ";
$newres=mysql_query($sched1);
$newresult=mysql_fetch_array($newres);
$deadline=$newresult['date'];
$sqln="SELECT sc.subject,sc.date,sc.slot,a.att FROM attendence as a,schedule as sc where sc.subject=a.subject and internal=1 and a.usn='$usn'";
$resultn=mysql_query($sqln);
$num=mysql_num_rows($resultn);
$sqlm="select * from subjects where usn='$usn'";
$resultm=mysql_query($sqlm);
$ress=mysql_fetch_array($resultm);
$sqlex="select * from register where usn='$usn' and internal=1";
...
$schedulet=0;
$date1=date('Y-m-d');
$try="select * from deadline where internal=1 and sem='$semester' ";
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<div class="row">
				 <h3>You have successfully registered for internals.<br>Please check your mail for room and seat details.<h3>
				</div>
                <!-- /.row -->

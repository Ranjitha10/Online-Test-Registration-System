...
$flow1="SELECT * FROM count1 WHERE sem='$sem'";
...
//$subarray =array( $s1,$s2,$s3,$s4,$s5,$s6,$s7,$s8);
...
if($sub1==1)
{
	$rfu1=$rf1['sub1']+1;
	$ca1=$rfu1;
	mysql_query("update count1 set sub1='$rfu1' where sem='$sem' ");
	$sql="insert into register values(1,'$res1[2]','$usn','','')";
	$result = mysql_query($sql,$con);
}
}
else
...
{	$rfu1=$rf1['sub2']+1;
	$ca2=$rfu1;
	mysql_query("update count1 set sub2='$rfu1' where sem='$sem' ");
	$sql="insert into register values(1,'$res1[3]','$usn','','')";
	$result = mysql_query($sql,$con);
}
}
else
...
if($sub3==1)
{
	$rfu1=$rf1['sub3']+1;
	$ca3=$rfu1;
	mysql_query("update count1 set sub3='$rfu1' where sem='$sem'");
	$sql="insert into register values(1,'$res1[4]','$usn','','')";
	$result = mysql_query($sql,$con);
}
}
else
...
if($sub4==1)
{
	$rfu1=$rf1['sub4']+1;
	$ca4=$rfu1;
	mysql_query("update count1 set sub4='$rfu1' where sem='$sem'");
	$sql="insert into register values(1,'$res1[5]','$usn','','')";
	$result = mysql_query($sql,$con);
}
}
else
...
if($sub5==1)
{
	...
	$rfu1=$rf1['sub5']+1;
	$ca5=$rfu1;
	mysql_query("update count1 set sub5='$rfu1' where sem='$sem'");
	$sql="insert into register values(1,'$res1[6]','$usn','','')";
	$result = mysql_query($sql,$con);
}
}
else
...
if($sub6==1)
{
	...
	$rfu1=$rf1['sub6']+1;
	$ca6=$rfu1;
	mysql_query("update count1 set sub6='$rfu1' where sem='$sem'");
	$sql="insert into register values(1,'$res1[7]','$usn','','')";
	$result = mysql_query($sql,$con);
}
}
else
...
if($sub7==1)
{
	...
	$rfu1=$rf1['sub7']+1;
	$ca7=$rfu1;
	mysql_query("update count1 set sub7='$rfu1' where sem='$sem'");
	$sql="insert into register values(1,'$res1[8]','$usn','','')";
	$result = mysql_query($sql,$con);
}
}
else
...
if($sub8==1)
{
	...
	$rfu1=$rf1['sub8']+1;
	$ca8=$rfu1;
	mysql_query("update count1 set sub8='$rfu1' where sem='$sem'");
	$sql="insert into register values(1,'$res1[9]','$usn','','')";
	$result = mysql_query($sql,$con);
}
}
else
...
foreach($subarray as $key => $value)
{
	...
	echo $subjectactive;
	$query1="select * from schedule where subject='$subjectactive' and internal=1";
	...
	if($counting<=2)
	{
		...
		if(is_numeric($countarray["$key"]))
		{
			...
			$subjectactive=$subarray["$key"];
			$updq="update register set roomno='$room', seatno='$seat' where usn='$usn' and subject='$subjectactive' and internal='1'";

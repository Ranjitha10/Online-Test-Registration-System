...
if(isset($_SESSION['usn']))
{
	...
	if (!$_SESSION['usn'] == '')
	{
		...
		if($count1>=1)
		{
			...
			$comm="SELECT sub8 FROM finalmarks WHERE usn='$usn' ";
                    ...
                    <div class="row">
						...
						<?php $sum1=$val1+$val2;
								...
								{   
									...
									//if($countcheck==1)
									//{
									$check=mysql_query("UPDATE finalmarks SET sub8='$total' WHERE usn='$usn'");
                        ...
                        <div  id="finalize"  style="width:300px;float:right"> <form method="post"  action="subj8.php">

                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                           ...
                           <li>
                             ...
                             <li class="active">
                                <i class="fa fa-fw fa-file"></i>Course Details
                            </li>
                        </ol>
                    </div>
                </div>
								...
								else
								{
									...
									if (!empty($_FILES["file"]))
									{
										...
										for($i =2;$i<$row-1; $i++)
										{
											$subcode = $data[$i][0];
											$subname=$data[$i][1];	
											$sql="insert into course_code values('$subname','$subcode','$acdyear')";
...
mysql_close($con);
								...
								echo '<div class="row">';
								echo '<h3 class = "center">Data updated Successfully <br><br> <a href="uploadcourse.php">Back to upload Page</a></h3>';
								echo '</div></div></div>';
							...
							{
								echo '<div class="row">';
								echo '<h3 class = "center">Wrong Format Uploaded <br><br> <a  href="uploadcourse.php">Back to upload Page</a></h3>';
								echo '</div></div></div>';

...
mysql_query("update room set roomrow='$room1' where roomno=1");
mysql_query("update room set roomrow='$room2' where roomno=2");
mysql_query("update room set roomrow='$room3' where roomno=3");
mysql_query("update room set roomrow='$room4' where roomno=4");
mysql_query("update room set roomrow='$room5' where roomno=5");
mysql_query("update room set roomrow='$room6' where roomno=6");
mysql_query("update room set roomrow='$room7' where roomno=7");
mysql_query("update room set roomrow='$room8' where roomno=8");
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
							...
							<li class="active">
								<i class="fa fa-fw fa-dashboard"></i>Room Size
							</li>
                        </ol>
                    </div>
                </div>
                ...
                <!-- /.row -->
                 <div class="row">
                    ...
                    <table style="width:60%; margin:0 auto; border:1px ">
                        
                        <legend>ROOM FIX</legend>
                            <table style="width:60%; margin:0 auto">
                                <tr><td><h3>Room 1:</h3></td>
                                <td><select name="room1">
										<option>Please enter the rows in room</option>
										<option value='3'>3</option>
										<option value='4'>4</option>
									</select
								</td></tr>
                                <tr><td><h3>Room2:</h3></td>
                              <td><select name="room2">
                                ...
                                <tr><td><h3>Room3:</h3></td>
                                 <td><select name="room3">
										<option>Please enter the rows in room</option>
										<option value='3'>3</option>
										<option value='4'>4</option>
									</select>
								</td></tr>
								<tr><td><h3>Room4:</h3></td>
                                 <td><select name="room4">
										<option>Please enter the rows in room</option>
										<option value='3'>3</option>
										<option value='4'>4</option>
									</select>
								</td></tr>
                                <tr><td><h3>Room5:</h3></td>
                                 <td><select name="room5">
										<option>Please enter the rows in room</option>
										<option value='3'>3</option>
										<option value='4'>4</option>
									</select>
								</td></tr>
								<tr><td><h3>Room6:</h3></td>
                                 <td><select name="room6">
										<option>Please enter the rows in room</option>
										<option value='3'>3</option>
										<option value='4'>4</option>
									</select>
								</td></tr>
								<tr><td><h3>Room7:</h3></td>
                                <td><select name="room7">
										<option>Please enter the rows in room</option>
										<option value='3'>3</option>
										<option value='4'>4</option>
									</select>
								</td></tr>
								<tr><td><h3>Room8:</h3></td>
                                 <td><select name="room8">
										<option>Please enter the rows in room</option>
										<option value='3'>3</option>
										<option value='4'>4</option>
									</select>
								</td></tr>
								<tr><td colspan="2" style="margin:0 auto;text-align:center"><input type="submit" class="btn btn-lg btn-primary" value="Submit" name="Submit"></td></tr>
                            </table>
                    </fieldset>
					</form>
                </div>

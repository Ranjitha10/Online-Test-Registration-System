        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- /.row -->
				  ...
				  <div class="row">
					<form name="upload_form" role="form" action="studentexcel.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                    <fieldset>
                        <legend>Select Semester</legend>
                        <p><b>NOTE: </b><i> Kindly select the semester for which you are uploading the student course details.</i><br><br>
                        <select name="sem">
							...
							<option value="0">Fastrack</option>

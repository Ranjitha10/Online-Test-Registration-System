                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                           ...
                           <li>
                             ...
                             <li class="active">
                                <i class="fa fa-fw fa-file"></i>Faculty Details
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <!-- /.row -->
                 <div class="row">
                    ...
                    <p> The file should follow some format as specified below:<br>
                        ...
                        <i>2. File should have 5 columns , with the headings as FID, Subject1 , Subject2... respectively.</i><br>
                        <i>3. Each row indicates an entry of a particular faculty detail.</i><br>
										...
										for($i = 2; $i < $row; $i++)
										{
											...
											if($sub4=='null'||$sub4=='NULL'||$sub4=='Null')
											{
												if($sub3=='null'||$sub3=='NULL'||$sub3=='Null')
												{
													...
													{
														$sql = " update  faculty set sub1='$sub1' WHERE fid='$fid'";
													}
													else
													{
														$sql="update  faculty set sub1='$sub1',sub2='$sub2' WHERE fid='$fid'";
													}
												}
												else
												{	
													$sql = " update  faculty set sub1='$sub1',sub2='$sub2',sub3='$sub3' WHERE fid='$fid'";
												}
											}
											else
											{
...
mysql_close($con);
								...
								echo '<div class="row">';
								echo '<h3 class = "center">Data updated Successfully <br><br> <a href="uploadfaculty.php">Back to upload Page</a></h3>';
								echo '</div></div></div>';
							...
							{
								echo '<div class="row">';
								echo '<h3 class = "center">Wrong Format Uploaded <br><br> <a  href="uploadfaculty.php">Back to upload Page</a></h3>';
								echo '</div></div></div>';

    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                ...
                                <i class="fa fa-fw fa-dashboard"></i>Faculty Details
                            </li>
                ...
                <!-- /.row -->
                 <div class="row">
                    <p><b>NOTE: </b><i> Here you have to upload a file which contains the details of the courses covered by each faculty.</i> </p>
                </br>
				...
				<div class="row">
				<img src="examplefacultydetail.png" style="width:80%;height:250px;align:center"> 
				</div><br>
                <div class="row">
                    
                        <fieldset>
						
                            <legend>Upload Faculty Details </legend>
							<form name="upload_form" role="form" action="facultyexcel.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div>

                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                           ...
                           <li>
                             ...
                             <li class="active">
                                <i class="fa fa-fw fa-file"></i>MARKS (<?php echo $res[7];?>)
                            </li>
                        </ol>
                    </div>
                </div>
								...
								else
								{
									...
									if (!empty($_FILES["file"]))
									{
										...
										for($i = 2; $i < $row; $i++)
										{
											...
											if($internal==1)
											{
												$sql = " insert into internal1  values('$usn' , '$res[7]' , '$marks')";
												$check=mysql_query($sql);
											}
											if($internal==2)
											{
												$sql = " insert into internal2  values('$usn' , '$res[7]' , '$marks')";
												$check=mysql_query($sql);
											}
											if($internal==3)
											{
												$sql = " insert into internal3  values('$usn' , '$res[7]' , '$marks')";
												$check=mysql_query($sql);
											}
...
mysql_close($con);
								...
								echo '<div class="row">';
								echo '<h3 class = "center">Data uploaded Successfully <br><br> <a href="marksub4.php">Back to upload Page</a></h3>';
								echo '</div></div></div>';
							}
							else
							{
								echo '<div class="row">';
								echo '<h3 class = "center">Wrong Format Uploaded <br><br> <a  href="marksub4.php">Back to upload Page</a></h3>';
								echo '</div></div></div>';

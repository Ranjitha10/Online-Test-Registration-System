...
<head>
    ...
    <script src="battatech_excelexport-master/Scripts/jquery.battatech.excelexport.js"></script>
                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                           ...
                           <li>
                             ...
                             <li class="active">
                                <i class="fa fa-fw fa-file"></i>Detail
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>@twitter</td>
						...
						<!--	 echo"<tr><td >TOTAL STUDENTS APPEARING:".$i."</td><td></td><td></td></tr></tbody></table></div>";-->
							
							
							
							<div>
							<button id="btnExport" class="btn btn-lg btn-primary"   type="submit" name="submit" value="Generate doc">Generate Doc</button>
							</div>
							</div>
			</div>

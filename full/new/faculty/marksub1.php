    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                           ...
                           <li>
                             ...
                             <li class="active">
                                <i class="fa fa-fw fa-file"></i>MARKS (<?php echo $res[4];?>)
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <!-- /.row -->
                <form name="upload_form" role="form" action="uploadm1.php" method="post" enctype="multipart/form-data" class="form-horizontal">
				 <div class="row">

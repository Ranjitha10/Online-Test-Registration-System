                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                           ...
                           <li>
                             ...
                             <li class="active">
                                <i class="fa fa-fw fa-file"></i>Assignment (<?php echo $sub1;?>)
                            </li>
                        </ol>
                    </div>
                </div>
									...
									if (!empty($_FILES["file"]))
									{
										...
										for($i = 2; $i < $row; $i++)
										{
											...
											$att=  $data[$i][1];
												...
												$sql = " update assignment set submission='$att'  where usn='$usn' AND subject='$sub1'";
...
mysql_close($con);
								...
								echo '<div class="row">';
								echo '<h3 class = "center">Data uploaded Successfully <br><br> <a href="asssub1.php">Back to upload Page</a></h3>';
								echo '</div></div></div>';
							}
							else
							{

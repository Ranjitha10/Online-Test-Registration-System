                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                           ...
                           <li>
                             ...
                             <li class="active">
                                <i class="fa fa-fw fa-file"></i>MARKS (<?php echo $sub2;?>)
                            </li>
                        </ol>
                    </div>
                </div>
								...
								else
								{
									...
									if (!empty($_FILES["file"]))
									{
										...
										for($i = 2; $i < $row; $i++)
										{
											...
											if($internal==1)
											{
												$sql = " insert into internal1  values('$usn' , '$sub2' , '$att')";
												$check=mysql_query($sql);
											}
											if($internal==2)
											{
												$sql = " insert into internal2  values('$usn' , '$sub2' , '$att')";
												$check=mysql_query($sql);
											}
											if($internal==3)
											{
												$sql = " insert into internal3  values('$usn' , '$sub2' , '$att')";
												$check=mysql_query($sql);
											}

...
$sub1=$res1['sub1'];
$fname=$res1['name'];
$sub2=$res1['sub2'];$fid=$_SESSION['fid'];
                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                           ...
                           <li>
                             ...
                             <li class="active">
                                <i class="fa fa-fw fa-file"></i>Attendance (<?php echo $sub2;?>)
                            </li>
                        </ol>
                    </div>
                </div>
									...
									if (!empty($_FILES["file"]))
									{
										...
										for($i = 2; $i < $row; $i++)
										{
											...
											$att=  $data[$i][1];
												...
												//$sql=" insert into attendence values('$usn','$sub2','$att')";
												$sql = " update attendence set att='$att'  where usn='$usn' AND subject='$sub2'";

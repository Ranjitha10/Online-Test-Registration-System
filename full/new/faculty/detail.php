    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- /.row -->
                 <div class="row">
					<form method="post" action="battatech_excelexport-master/detail.php" name="Submit" style="margin:0 auto">
						<table >
						...
						<tr ><td  colspan="2"><input type="submit" class="btn btn-lg btn-primary" value="View Excel Sheet" name="Submit"></td></tr>
						</table>
					</form>
				</div>

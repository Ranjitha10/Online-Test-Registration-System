            ...
            <div class="container-fluid">
                ...
                <!-- /.row -->
                 <div class="row">
                    ...
                    <p> The file should follow some format as specified below:<br>
                        ...
                        <i>2. File should have 2 columns , with the headings as USN and Attendance repectively.</i><br>
                ...
                <div class="row">
                        ...
                        <fieldset>
							...
							<form name="upload_form" role="form" action="attendance1.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div>

    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- /.row -->
                <form name="upload_form" role="form" action="uploadm4.php" method="post" enctype="multipart/form-data" class="form-horizontal">
				 <div class="row">
				 
                    <fieldset>
                        <legend>Internal</legend>
                        <p><b>NOTE: </b><i> Kindly select the test for which you are uploading the marks.</i><br><br>
                        <select name="inter">

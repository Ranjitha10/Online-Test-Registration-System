            ...
            <div class="container-fluid">
              ...
              <?php
							...
							if( (($ext=="xls") || ($ext=="xlsx")) && in_array($extension, $allowedExts) )
							{
									...
									if (!empty($_FILES["file"]))
									{
										...
										for($i = 2; $i < $row; $i++)
										{
											...
											$att=  $data[$i][1];
												...
												$sql = " update  attendence set att='$att' WHERE usn='$fid' AND subject='$res[5]'";
								...
								echo '<div class="row">';
								echo '<h3 class = "center">Data updated Successfully <br><br> <a href="attsub2.php">Back to upload Page</a></h3>';
								echo '</div>';
							...
							{
								echo '<div class="row">';
								echo '<h3 class = "center">Wrong Format Uploaded <br><br> <a  href="attsub2.php">Back to upload Page</a></h3>';
								echo '</div>';

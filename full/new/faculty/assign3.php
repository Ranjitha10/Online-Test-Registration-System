    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                           ...
                           <li>
                             ...
                             <li class="active">
                                <i class="fa fa-fw fa-file"></i>ASSIGNMENT (<?php echo $res[6];?>)
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <!-- /.row -->
                 <div class="row">
                    <p><b>NOTE: </b><i> Here you have to upload a file which contains the database of the students undertaking this particular subject and also their ASSIGNMENT marks in this subject.</i> </p>
                </br>
                    <p> The file should follow some format as specified below:<br>
                        <i>1. File should be a *.xlsx extension file.</i><br>
                        <i>2. File should have 2 columns , with the headings as USN  and Assignmnet marks repectively.</i><br>
              ...
              <?php
							...
							if( (($ext=="xls") || ($ext=="xlsx")) && in_array($extension, $allowedExts) )
							{
									...
									if (!empty($_FILES["file"]))
									{
										...
										for($i = 2; $i < $row; $i++)
										{
											...
											$marks=  $data[$i][1];
												...
												$sql = " update  assignment set submission='$marks' WHERE usn='$fid' AND subject='$res[6]'";
								...
								echo '<div class="row">';
								echo '<h3 class = "center">Data updated Successfully <br><br> <a href="asssub3.php">Back to upload Page</a></h3>';
								echo '</div>';
							...
							{
								echo '<div class="row">';
								echo '<h3 class = "center">Wrong Format Uploaded <br><br> <a  href="asssub3.php">Back to upload Page</a></h3>';
								echo '</div>';

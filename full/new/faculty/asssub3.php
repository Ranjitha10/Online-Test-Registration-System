    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<div class="row">
				<img src="exampleass.png" style="width:80%;height:250px;align:center"> 
				</div><br>
                <div class="row">
                        ...
                        <fieldset>
							...
							<form name="upload_form" role="form" action="assign3.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div>

...
$email = $_POST['email'];
	...
	$sql="SELECT * FROM faculty WHERE fid='$_POST[fid]' and email='$email'";
...
$mail->Body    = $name.'YOUR FID IS:'.$fid."<br>".'YOUR PASSWORD IS:'.$password;
      ...
      <div class="modal-body">
          <form action="#" method="post" name="login"class="form col-md-12 center-block">
            <div class="form-group">
              <input type="text" class="form-control input-lg" name="fid" placeholder="Faculty id" id="fid" onblur="myfunction()" required>
            </div>
            <div class="form-group">
